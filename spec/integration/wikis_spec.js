...
describe("routes : wikis", () => {
    ...
    describe("guest performing CRUD operation on wiki resource", () => {
        beforeEach((done) => {
            request.get({
        ...
        describe("POST /wikis/create", ()=> {
            it("should not create a wiki and redirect", (done) => {
                const options = {
                    url: `${base}/create`,
                    form: {
                        title: "My first wiki",
        ...
        describe("GET /wikis/:id/edit", () => {
            it("should not render a view to edit the wiki", (done) => {
                Wiki.create({
                    title: "My first wiki",
                    body: "This site is great!",
                    userId: this.user.id
        ...
        describe("POST /wikis/:id/update", () => {
            it("should not update the wiki", (done) => {
                Wiki.create({
                    title: "My first wiki",
                    body: "This site is great!",
                    userId: this.user.id
    ...
    describe("standard user performing CRUD operations on resource topic", () => {
        beforeEach((done) => {
            request.get({
                url: "http://localhost:3000/auth/fake",
                form: {
